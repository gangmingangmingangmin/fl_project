...
class TimeSeriesLoader:
    ...
    def get_chunk(self, idx):
        ...
        with open('/home/ec2-user/data/sub_metering_scaled_data/ts_file'+str(ind)+'.pkl','rb') as f:
            df_ts = pickle.load(f)
...
class flClient(fl.client.NumPyClient):
    ...
    def fit(self,parameters,config):
        tss=TimeSeriesLoader(config['file_n'])
        BATCH_SIZE = 128
    ...
    def evaluate(self, parameters, config):
        # testdata
        df_val_ts = pd.read_pickle('data/sub_metering_val_scaled_data/ts_file0.pkl')
        ...
        with open('data/sub_metering_scaler.pickle','rb') as f:
